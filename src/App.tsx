...
const ELEVENLABS_KEY = "4084d953fb5b92c7bbeeca332b2b43d013bd7d769ccc1330e55b5e61bcb57edc";
...
const orb=(color:string,w:string,h:string,top?:string,left?:string,right?:string,bottom?:string,anim?:string)=>({
  position:"absolute" as const,width:w,height:h,borderRadius:"50%",
  background:color,filter:"blur(80px)",pointerEvents:"none" as const,
  opacity:.2,top,left,right,bottom,animation:anim
});

const grid={position:"absolute" as const,inset:0,backgroundImage:`linear-gradient(rgba(255,107,53,.04) 1px,transparent 1px),linear-gradient(90deg,rgba(255,107,53,.04) 1px,transparent 1px)`,backgroundSize:"48px 48px"};
  ...
  return(
    <section id="system" style={{position:"relative",padding:"6rem 0",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:1100,margin:"0 auto",padding:"0 2rem",position:"relative",zIndex:2}}>
        ...
        <div style={{background:"#1A1208",borderRadius:14,padding:"1.5rem 2rem",border:"0.5px solid rgba(255,107,53,0.15)"}}>
          <div style={{fontSize:11,color:"rgba(250,250,248,0.45)",marginBottom:"1rem",letterSpacing:".08em",textTransform:"uppercase"}}>System diagram · How data flows</div>
        ...
        <div style={{width:360,background:"#1A1208",border:"0.5px solid rgba(255,107,53,.3)",borderRadius:20,overflow:"hidden",boxShadow:"0 24px 64px rgba(0,0,0,.6)",animation:"fab-pop .3s ease"}}>
          ...
          {tab==="voice"&&(
            <div style={{padding:"1.5rem",display:"flex",flexDirection:"column",alignItems:"center",gap:"1rem"}}>
              ...
              <p style={{fontSize:12,color:"rgba(250,250,248,0.45)",textAlign:"center"}}>{calling?speaking?"Riva is speaking…":"Processing…":"Tap to start a voice call"}</p>
